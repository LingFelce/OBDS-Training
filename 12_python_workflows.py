...
show - shows which functions will run when you run the pipeline
plot - plots a schematic showing the status of the pipeline functions (and what has/hasn't run yet)
make - run the pipeline
touch - touch the output files which would be generated by running the pipeline but do not run it
